...
#import "TestShimmering.h"
#import "JOShimmeringView.h"

@interface TestShimmering ()

@end

@implementation TestShimmering {
    UIImageView *_wallpaperView;
    JOShimmeringView *_shimmeringView;
    UILabel *_logoLabel;
...
- (void)testShimmering {
    ...
    _shimmeringView = [[JOShimmeringView alloc] init];
