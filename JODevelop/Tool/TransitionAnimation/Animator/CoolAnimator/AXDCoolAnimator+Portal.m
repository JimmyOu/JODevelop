...
@implementation AXDCoolAnimator (Portal)
    ...
    [UIView animateWithDuration:self.toDuration
                     ...
                     animations:^{
                         ...
                         if ([transitionContext transitionWasCancelled]) {
                             ...
                             [self p_removeOtherViews:fromView];
                         } else {
                             [containerView addSubview:toView];
                             [self p_removeOtherViews:toView];
                         }
...
- (void)p_removeOtherViews:(UIView*)viewToKeep {
