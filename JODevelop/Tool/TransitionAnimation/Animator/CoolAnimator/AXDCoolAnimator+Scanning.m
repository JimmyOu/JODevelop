...
@implementation AXDCoolAnimator (Scanning)

- (void)setScanningToAnimation:(id<UIViewControllerContextTransitioning>)transitionContext direction:(NSUInteger)direction {
    [self p_animateTransition:transitionContext duration:self.toDuration direction:direction];
...
- (void)p_animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext duration:(NSTimeInterval)duration direction:(NSInteger)direction{
