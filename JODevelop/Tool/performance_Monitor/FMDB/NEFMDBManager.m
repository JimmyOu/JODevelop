...
@end
@implementation NEFMDBManager


static NEFMDBManager *nedb = nil;
+ (instancetype)shareDatabase
{
    return [NEFMDBManager shareDatabase:nil];
}

+ (instancetype)shareDatabase:(NSString *)dbName
{
    return [NEFMDBManager shareDatabase:dbName path:nil];
}
...
{
    return [self ne_createTable:tableName dicOrModel:parameters excludeName:nil];
}

- (BOOL)ne_createTable:(NSString *)tableName dicOrModel:(id)parameters excludeName:(NSArray *)nameArr
{
...
{
    return [self ne_alterTable:tableName dicOrModel:parameters excludeName:nil];
}

- (BOOL)ne_alterTable:(NSString *)tableName dicOrModel:(id)parameters excludeName:(NSArray *)nameArr
{
    __block BOOL flag;
    [self ne_inTransaction:^(BOOL *rollback) {
        if ([parameters isKindOfClass:[NSDictionary class]]) {
