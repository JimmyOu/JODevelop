...
@implementation NSObject (NEMemoryLeak)
...
- (void)assertNotDealloc {
    if ([NELeakedObjectProxy isAnyObjectLeakedAtPtrs:[self parentPtrs]]) {
        return;
    }
    [NELeakedObjectProxy addLeakedObject:self];
