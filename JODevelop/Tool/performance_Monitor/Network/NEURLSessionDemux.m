...
@interface NEURLSessionDemuxTaskInfo : NSObject
...
@end
@interface NEURLSessionDemuxTaskInfo ()
...
@implementation NEURLSessionDemuxTaskInfo
...
@interface NEURLSessionDemux () <NSURLSessionDataDelegate>
...
@end
@implementation NEURLSessionDemux
...
- (NSURLSessionDataTask *)dataTaskWithRequest:(NSURLRequest *)request delegate:(id<NSURLSessionDataDelegate>)delegate modes:(NSArray *)modes {
    ...
    NEURLSessionDemuxTaskInfo *    taskInfo;
    ...
    taskInfo = [[NEURLSessionDemuxTaskInfo alloc] initWithTask:task delegate:delegate modes:modes];
...
- (NEURLSessionDemuxTaskInfo *)taskInfoForTask:(NSURLSessionTask *)task
{
    NEURLSessionDemuxTaskInfo *    result;
